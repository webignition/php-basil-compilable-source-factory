    ...
    public static function isNotAssertionFunctionalDataProvider(): array
    {
        ...
        $assertions = [
            'element identifier examined value, scalar expected value' => [
                'assertion' => $assertionParser->parse('$".selector" is-not "incorrect value"', 0),
            ],
            'attribute identifier examined value, scalar expected value' => [
                'assertion' => $assertionParser->parse('$".selector".data-test-attribute is-not "incorrect value"', 0),
            ],
            'environment examined value, scalar expected value' => [
                'assertion' => $assertionParser->parse('$env.TEST1 is-not "incorrect value"', 0),
            ],
            'browser object examined value, scalar expected value' => [
                'assertion' => $assertionParser->parse('$browser.size is-not "1x1"', 0),
            ],
            'page object examined value, scalar expected value' => [
                'assertion' => $assertionParser->parse('$page.title is-not "incorrect value"', 0),
            ],
            'element identifier examined value, element identifier expected value' => [
                'assertion' => $assertionParser->parse('$".selector" is-not $".secondary-selector"', 0),
            ],
            'element identifier examined value, attribute identifier expected value' => [
                'assertion' => $assertionParser->parse('$".selector" is-not $".selector".data-browser-size', 0),
            ],
            ...
            'attribute identifier examined value, browser object expected value' => [
                'assertion' => $assertionParser->parse('$".selector".data-test-attribute is-not $browser.size', 0),
            ],
            'attribute identifier examined value, page object expected value' => [
                'assertion' => $assertionParser->parse('$".selector".data-browser-size is-not $page.title', 0),
            ],
            'select element identifier examined value, scalar expected value (1)' => [
                'assertion' => $assertionParser->parse('$".select-none-selected" is-not "incorrect value"', 0),
            ],
            'select element identifier examined value, scalar expected value (2)' => [
                'assertion' => $assertionParser->parse('$".select-has-selected" is-not "incorrect value"', 0),
            ],
            'option collection element identifier examined value, scalar expected value (1)' => [
                'assertion' => $assertionParser->parse('$".select-none-selected option" is-not "incorrect value"', 0),
            ],
            'option collection element identifier examined value, scalar expected value (2)' => [
                'assertion' => $assertionParser->parse('$".select-has-selected option" is-not "incorrect value"', 0),
            ],
            'radio group element identifier examined value, scalar expected value (1)' => [
                'assertion' => $assertionParser->parse('$"input[name=radio-not-checked]" is-not "incorrect value"', 0),
            ],
            'radio group element identifier examined value, scalar expected value (2)' => [
                'assertion' => $assertionParser->parse('$"input[name=radio-checked]" is-not "incorrect value"', 0),
            ],
        ];
